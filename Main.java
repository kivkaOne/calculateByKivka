...
public class Main {
    ...
    public static String transform(String expression) {
        ...
        if (Roman.isRomanValue(Roman.romanValues[0]) && Roman.isRomanValue(Roman.romanValues[1])) {
            ...
            throw new RuntimeException("Числа должны быть либо оба римские либо оба арабские");
        }
